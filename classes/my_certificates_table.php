...
class my_certificates_table extends \table_sql  {
    ...
    public function col_download($certificate) {
        ...
        $link = new \moodle_url('/blocks/userprofile_update/certificates.php',
            ['userid' => $this->userid,
    ...
    public function query_db($pagesize, $useinitialsbar = true) {
        $total = \mod_customcert\certificate::get_number_of_certificates_for_user($this->userid);

        $this->pagesize($pagesize, $total);

        $this->rawdata = \mod_customcert\certificate::get_certificates_for_user($this->userid, $this->get_page_start(),
